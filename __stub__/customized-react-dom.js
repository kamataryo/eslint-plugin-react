...

{
  ...
  if (typeof window !== 'undefined' && typeof window.dispatchEvent === 'function' && typeof document !== 'undefined' && typeof document.createEvent === 'function') {
    ...
    var invokeGuardedCallbackDev = function (name, func, context, a, b, c, d, e, f) {
      ...
      !(typeof document !== 'undefined') ? invariant_1$1(false, 'The `document` global was defined when React was initialized, but is not defined anymore. This can happen in a test environment if a component schedules an update from an asynchronous callback, but the test has already finished running. To solve this, you can either unmount the component at the end of your test (and ensure that any asynchronous operations get canceled in `componentWillUnmount`), or you can change the test itself to be asynchronous.') : void 0;
    ...
    for (var typeSpecName in typeSpecs) {
      if (typeSpecs.hasOwnProperty(typeSpecName)) {
        ...
        try {
          ...
          invariant$4(typeof typeSpecs[typeSpecName] === 'function', '%s: %s type `%s` is invalid; it must be a function, usually from ' + 'the `prop-types` package, but received `%s`.', componentName || 'React class', location, typeSpecName, typeof typeSpecs[typeSpecName]);
...
var shallowEqual_1$1 = shallowEqual$2;
...
function coerceRef(returnFiber, current, element) {
  ...
  if (mixedRef !== null && typeof mixedRef !== 'function' && typeof mixedRef !== 'object') {
    ...
    if (element._owner) {
      ...
      !element._owner ? invariant_1$1(false, 'Element ref was specified as a string (%s) but no owner was set. This could happen for one of the following reasons:\n1. You may be adding a ref to a functional component\n2. You may be adding a ref to a component that was not created inside a component\'s render method\n3. You have multiple copies of React loaded\nSee https://fb.me/react-refs-must-have-owner for more information.', mixedRef) : void 0;
    }
  }
  return mixedRef;
}
...
var ReactFiberCompleteWork = function (config, hostContext, legacyContext, newContext, hydrationContext) {
  ...
  function moveCallToHandlerPhase(current, workInProgress, renderExpirationTime) {
    ...
    !props ? invariant_1$1(false, 'Should be resolved by now. This error is likely caused by a bug in React. Please file an issue.') : void 0;
...
var ReactFiberCommitWork = function (config, captureError, scheduleWork, computeExpirationForFiber, markLegacyErrorBoundaryAsFailed, recalculateCurrentTime) {
  ...
  function commitErrorLogging(finishedWork, onUncaughtError) {
    switch (finishedWork.tag) {
      case ClassComponent:
        {
          ...
          var updateQueue = finishedWork.updateQueue;
          !(updateQueue !== null && updateQueue.capturedValues !== null) ? invariant_1$1(false, 'An error logging effect should not have been scheduled if no errors were captured. This error is likely caused by a bug in React. Please file an issue.') : void 0;
      ...
      case HostRoot:
        {
          ...
          !(_updateQueue2 !== null && _updateQueue2.capturedValues !== null) ? invariant_1$1(false, 'An error logging effect should not have been scheduled if no errors were captured. This error is likely caused by a bug in React. Please file an issue.') : void 0;
      ...
      default:
        invariant_1$1(false, 'This unit of work tag cannot capture errors.  This error is likely caused by a bug in React. Please file an issue.');
    }
  }
    ...
    for (var typeSpecName in typeSpecs) {
      if (typeSpecs.hasOwnProperty(typeSpecName)) {
        ...
        try {
          // This is intentionally an invariant that gets caught. It's the same
          // behavior as without this statement except with a better message.
          invariant$5(typeof typeSpecs[typeSpecName] === 'function', '%s: %s type `%s` is invalid; it must be a function, usually from ' + 'the `prop-types` package, but received `%s`.', componentName || 'React class', location, typeSpecName, typeof typeSpecs[typeSpecName]);
...
var ReactFiberScheduler = function (config) {
  ...
  function commitRoot(finishedWork) {
    ...
    !(committedExpirationTime !== NoWork) ? invariant_1$1(false, 'Cannot commit an incomplete root. This error is likely caused by a bug in React. Please file an issue.') : void 0;
  ...
  function renderRoot(root, expirationTime, isAsync) {
    ...
    if (didFatal) {
      ...
      if (isRootReadyForCommit) {
        ...
        invariant_1$1(false, 'Expired work should have completed. This error is likely caused by a bug in React. Please file an issue.');
      }
    } else {
  ...
  function dispatch(sourceFiber, value, expirationTime) {
    !(!isWorking || isCommitting) ? invariant_1$1(false, 'dispatch: Cannot dispatch during the render phase.') : void 0;
  ...
  function flushRoot(root, expirationTime) {
    !!isRendering ? invariant_1$1(false, 'work.commit(): Cannot commit while already rendering. This likely means you attempted to commit from inside a lifecycle method.') : void 0;
...
var ExecutionEnvironment_1$1 = ExecutionEnvironment$2;
...
{
  if (ExecutionEnvironment_1$1.canUseDOM && typeof requestAnimationFrame !== 'function') {
...
if (!ExecutionEnvironment_1$1.canUseDOM) {
...
function validateProps(element, props) {
  // TODO (yungsters): Remove support for `selected` in <option>.
  {
    if (props.selected != null && !didWarnSelectedSetOnOption) {
      warning_1$1(false, 'Use the `defaultValue` or `value` props on <select> instead of ' + 'setting `selected` on <option>.');
...
function getHostProps$1(element, props) {
  var hostProps = objectAssign({ children: undefined }, props);
...
var DOMnamespaces = Object.freeze({
...
var warnValidStyle = emptyFunction_1$1;

{
  ...
  var warnHyphenatedStyleName = function (name, getStack) {
    ...
    warning_1$1(false, 'Unsupported style property %s. Did you mean %s?%s', name, camelizeStyleName_1(name), getStack());
  };
...
var isCustomComponent$2 = Object.freeze({
	default: isCustomComponent
});
...
function validateProperty(tagName, name) {
  if (hasOwnProperty$3.call(warnedProperties, name) && warnedProperties[name]) {
    return true;
  }
  ...
  validateProperty$1 = function (tagName, name, value, canUseEventSystem) {
    ...
    if (canUseEventSystem) {
      ...
      if (INVALID_EVENT_NAME_REGEX.test(name)) {
        warning_1$1(false, 'Invalid event handler property `%s`. ' + 'React events use the camelCase naming convention, for example `onClick`.%s', name, getStackAddendum$2());
      }
      warnedProperties$1[name] = true;
      return true;
    }
...
var getStack = emptyFunction_1$1.thatReturns('');
...

{
  ...
  warnForInvalidEventListener = function (registrationName, listener) {
    if (listener === false) {
      ...
      warning_1$1(false, 'Expected `%s` listener to be a function, instead got a value of `%s` type.%s', registrationName, typeof listener, getCurrentFiberStackAddendum$3());
    }
  };
...
function trapClickOnNonInteractiveElement(node) {
  ...
  node.onclick = emptyFunction_1$1;
}
...
function setInitialProperties$1(domElement, tag, rawProps, rootContainerElement) {
  var isCustomComponentTag = isCustomComponent(tag, rawProps);
  {
    ...
    if (isCustomComponentTag && !didWarnShadyDOM && domElement.shadyRoot) {
      warning_1$1(false, '%s is using shady DOM. Using shady DOM with React can ' + 'cause things to break subtly.', getCurrentFiberOwnerName$2() || 'A component');
...
var validateDOMNesting = emptyFunction_1$1;
...

{
  ...
  if (typeof Map !== 'function' || Map.prototype == null || typeof Map.prototype.forEach !== 'function' || typeof Set !== 'function' || Set.prototype == null || typeof Set.prototype.clear !== 'function' || typeof Set.prototype.forEach !== 'function') {
    warning_1$1(false, 'React depends on Map and Set built-in types. Make sure that you load a ' + 'polyfill in older browsers. https://fb.me/react-polyfills');
  }
...
var ReactDOM = {
  ...
  shared: {
    isCustomComponent: isCustomComponent$2,
    DOMnamespaces: DOMnamespaces
  }
};
